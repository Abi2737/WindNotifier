...
class _$_AppState$ implements _AppState$ {
  const _$_AppState$({this.bottomBarIndex = 0});
  ...
  @override
  String toString() {
    return 'AppState(bottomBarIndex: $bottomBarIndex)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(bottomBarIndex));
...
abstract class _AppState$ implements AppState {
  const factory _AppState$({final int bottomBarIndex}) = _$_AppState$;
